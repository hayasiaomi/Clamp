namespace ShanDian.Webwork
{
    ...
    {
        private readonly IController module;

        /// <summary>
        /// Initializes a new instance of the <see cref="ViewRenderer"/> class.
        /// </summary>
        /// <param name="module">The <see cref="IController"/> instance that is rendering the view.</param>
        public ViewRenderer(IController module)
        {
            this.module = module;
        }
