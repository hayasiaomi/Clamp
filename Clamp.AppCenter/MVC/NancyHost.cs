...
namespace Clamp.AppCenter.MVC
{
    ...
    public class NancyHost : IDisposable
    {
        ...
        private readonly IWebworkEngine engine;
        private readonly HostConfiguration configuration;
        private readonly IWebworkBootstrapper bootstrapper;
        ...
        public NancyHost(params Uri[] baseUris)
            : this(WebwrokBootstrapperLocator.Bootstrapper, new HostConfiguration(), baseUris) { }
        ...
        public NancyHost(HostConfiguration configuration, params Uri[] baseUris)
            : this(WebwrokBootstrapperLocator.Bootstrapper, configuration, baseUris){}
        ...
        /// <param name="baseUris">The <see cref="Uri"/>s that the host will listen to.</param>
        public NancyHost(IWebworkBootstrapper bootstrapper, params Uri[] baseUris)
        ...
        /// <param name="configuration">Configuration to use</param>
        /// <param name="baseUris">The <see cref="Uri"/>s that the host will listen to.</param>
        public NancyHost(IWebworkBootstrapper bootstrapper, HostConfiguration configuration, params Uri[] baseUris)
        {
        ...
        /// <param name="bootstrapper">The bootstrapper that should be used to handle the request.</param>
        public NancyHost(Uri baseUri, IWebworkBootstrapper bootstrapper)
        ...
        /// <param name="bootstrapper">The bootstrapper that should be used to handle the request.</param>
        /// <param name="configuration">Configuration to use</param>
        public NancyHost(Uri baseUri, IWebworkBootstrapper bootstrapper, HostConfiguration configuration)
