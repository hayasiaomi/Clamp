namespace ShanDian.Webwork.Diagnostics.Controllers
{
    using System;
    ...
    public class InteractiveController : DiagnosticController
    {
        private readonly IInteractiveDiagnostics interactiveDiagnostics;

        public InteractiveController(IInteractiveDiagnostics interactiveDiagnostics)
            : base("/interactive")
        {
            ...
            Get["/providers/{providerName}/{methodName}"] = ctx =>
            {
                ...
                object[] arguments = GetArguments(method, this.Request.Query);
