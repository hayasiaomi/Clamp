namespace ShanDian.Webwork.Responses.Negotiation
{
    ...
    public interface IResponseProcessor
    {
        ...
        ProcessorMatch CanProcess(MediaRange requestedMediaRange, dynamic model, WebworkContext context);
        ...
        Response Process(MediaRange requestedMediaRange, dynamic model, WebworkContext context);
    }
}