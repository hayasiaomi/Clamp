namespace Clamp.Webwork.Security
{
    using System;
    ...
    public static class ModuleSecurity
    {
        ...
        public static void RequiresAuthentication(this IController module)
        {
        ...
        public static void RequiresClaims(this IController module, IEnumerable<string> requiredClaims)
        {
            module.AddBeforeHookOrExecute(SecurityHooks.RequiresAuthentication(), "Requires Authentication");
        ...
        /// <param name="module">Module to enable</param>
        /// <param name="requiredClaims">Claim(s) required</param>
        public static void RequiresClaims(this IController module, params string[] requiredClaims)
        {
        ...
        /// <param name="module">Module to enable</param>
        /// <param name="requiredClaims">Claim(s) required</param>
        public static void RequiresAnyClaim(this IController module, IEnumerable<string> requiredClaims)
        {
            module.AddBeforeHookOrExecute(SecurityHooks.RequiresAuthentication(), "Requires Authentication");
        ...
        /// <param name="module">Module to enable</param>
        /// <param name="requiredClaims">Claim(s) required</param>
        public static void RequiresAnyClaim(this IController module, params string[] requiredClaims)
        {
        ...
        public static void RequiresValidatedClaims(this IController module, Func<IEnumerable<string>, bool> isValid)
        {
            module.AddBeforeHookOrExecute(SecurityHooks.RequiresAuthentication(), "Requires Authentication");
        ...
        /// </summary>
        /// <param name="module">The <see cref="IController"/> that requires HTTPS.</param>
        public static void RequiresHttps(this IController module)
        {
        ...
        public static void RequiresHttps(this IController module, bool redirect)
        {
        ...
        public static void RequiresHttps(this IController module, bool redirect, int httpsPort)
        {
