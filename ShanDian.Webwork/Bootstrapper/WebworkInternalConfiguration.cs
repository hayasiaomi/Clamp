namespace ShanDian.Webwork.Bootstrapper
{
    ...
    /// </summary>
    public sealed class WebworkInternalConfiguration
    {
        /// <summary>
        /// Gets the Nancy default configuration
        /// </summary>
        public static WebworkInternalConfiguration Default
        {
            get
            {
                return new WebworkInternalConfiguration
                {
                    RouteResolver = typeof(DefaultRouteResolver),
                    RoutePatternMatcher = typeof(DefaultRoutePatternMatcher),
                    ContextFactory = typeof(DefaultWebworkContextFactory),
                    WebworkEngine = typeof(WebworkEngine),
                    ...
                    WebworkModuleBuilder = typeof(DefaultWebworkModuleBuilder),
                    ...
                    StatusCodeHandlers = new List<Type>(AppDomainAssemblyTypeScanner.TypesOf<IStatusCodeHandler>(ScanMode.ExcludeWebwork).Concat(new[] { typeof(DefaultStatusCodeHandler) })),
                    CsrfTokenValidator = typeof(DefaultCsrfTokenValidator),
                    ObjectSerializer = typeof(DefaultObjectSerializer),
                    Serializers = AppDomainAssemblyTypeScanner.TypesOf<ISerializer>(ScanMode.ExcludeWebwork).Union(new List<Type>(new[] { typeof(DefaultJsonSerializer), typeof(DefaultXmlSerializer) })).ToList(),
        ...
        public Type WebworkEngine { get; set; }
        ...
        public Type WebworkModuleBuilder { get; set; }
        ...
        public static WebworkInternalConfiguration WithOverrides(Action<WebworkInternalConfiguration> configurationBuilder)
        {
        ...
        public IEnumerable<TypeRegistration> GetTypeRegistations()
        {
            return new[]
            {
                ...
                new TypeRegistration(typeof(IWebworkEngine), this.WebworkEngine),
                new TypeRegistration(typeof(IRouteCache), this.RouteCache),
                new TypeRegistration(typeof(IRouteCacheProvider), this.RouteCacheProvider),
                new TypeRegistration(typeof(IRoutePatternMatcher), this.RoutePatternMatcher),
                new TypeRegistration(typeof(IViewLocator), this.ViewLocator),
                new TypeRegistration(typeof(IViewFactory), this.ViewFactory),
                new TypeRegistration(typeof(IWebworkContextFactory), this.ContextFactory),
