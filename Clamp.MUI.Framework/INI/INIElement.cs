...
namespace Clamp.MUI.Framework.INI
{
    ...
    {
        internal INIElement(string name)
        {
        ...
        private string GetFormattedComment()
        {
            ...
            return (INIFile.PreferredCommentChar + " " + comment);
        }
        ...
        private string GetFormattedPreComment()
        {
            ...
            return string.Join(Environment.NewLine, Array.ConvertAll(lines, s => INIFile.PreferredCommentChar + " " + s));
        }
