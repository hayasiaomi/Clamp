...
namespace Clamp.Machine.Services
{
    public class UserService : IUserService
    {
        ...
        public SDApiResponse<object> AddUser(VMUserIn userInDto)
        {
        ...
        public SDApiResponse<object> AlterUser(VMUserInfoIn userInfoInDto)
        {
            SDApiResponse<object> apiResponse;
        ...
        public SDApiResponse<object> AlterUserRole(VMUserRolePermissionIn userRolePermissionInDto)
        {
        ...
        public SDApiResponse<object> VerificationUser(VMVerificationUserIn verificationUserInDto)
        {
            ...
            try
            {
                ...
                CVerificationUserInDto cVerificationUserInDto = new CVerificationUserInDto()
                {
                    ...
                    NickName = verificationUserInDto.UserName
