namespace Clamp.Webwork.Conventions
{
    ...
    public static class StaticContentsConventionsExtensions
    {
        ...
        public static void AddDirectory(this IList<Func<WebworkContext, string, Response>> conventions, string requestedPath, string contentPath = null, params string[] allowedExtensions)
        {
        ...
        public static void AddFile(this IList<Func<WebworkContext, string, Response>> conventions, string requestedFile, string contentFile)
        {
