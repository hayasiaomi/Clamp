namespace ShanDian.Webwork.Cookies
{
    using System;
    ...
    /// </summary>
    public class WebworkCookie : IWebworkCookie
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebworkCookie"/> class.
        /// </summary>
        /// <param name="name">The name of the cookie.</param>
        /// <param name="value">The value of the cookie.</param>
        public WebworkCookie(string name, string value)
        ...
        public WebworkCookie(string name, string value, DateTime expires)
        ...
        public WebworkCookie(string name, string value, bool httpOnly)
        ...
        public WebworkCookie(string name, string value, bool httpOnly, bool secure)
        ...
        /// <param name="secure">Whether the cookie is secure (i.e. HTTPS only).</param>
        /// <param name="expires">The expiration date of the cookie. Can be <see langword="null" /> if it should expire at the end of the session.</param>
        public WebworkCookie(string name, string value, bool httpOnly, bool secure, DateTime? expires)
        {
            this.Name = name;
            this.Value = value;
