...
namespace ShanDian.AddIns.Print.Html.Compiler
{
    internal class HelperFunctionBinder : HandlebarsExpressionVisitor
    {
        ...
        {
            return HtmlTemplateExpression.Boolish(Visit(bex.Condition));
        }

        protected override Expression VisitBlockHelperExpression(BlockHelperExpression bhex)
        {
            return HtmlTemplateExpression.BlockHelper(
                bhex.HelperName,
        ...
        {
            return HtmlTemplateExpression.SubExpression(
            ...
            IEnumerable<object> arguments)
        {
            ...
            {
                throw new HtmlTemplateRuntimeException(string.Format("Template references a helper that is not registered. Could not find helper '{0}'", helperName));
            }
        }
    }
}
