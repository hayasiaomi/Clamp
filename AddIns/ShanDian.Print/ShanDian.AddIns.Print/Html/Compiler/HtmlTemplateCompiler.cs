...
{
    internal class HtmlTemplateCompiler
    {
        private Tokenizer _tokenizer;
        private FunctionBuilder _functionBuilder;
        private ExpressionBuilder _expressionBuilder;
        private HtmlTemplateConfiguration _configuration;

        public HtmlTemplateCompiler(HtmlTemplateConfiguration configuration)
        {
