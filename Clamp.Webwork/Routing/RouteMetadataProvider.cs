namespace Clamp.Webwork.Routing
{
    ...
    public abstract class RouteMetadataProvider<TMetadata> : IRouteMetadataProvider
    {
        ...
        public Type GetMetadataType(IController module, RouteDescription routeDescription)
        {
        ...
        public object GetMetadata(IController module, RouteDescription routeDescription)
        {
        ...
        /// <param name="routeDescription">A <see cref="RouteDescription"/> for the route.</param>
        /// <returns>An instance of <typeparamref name="TMetadata"/>.</returns>
        protected abstract TMetadata GetRouteMetadata(IController module, RouteDescription routeDescription);
    }
}