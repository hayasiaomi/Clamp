namespace ShanDian.Webwork.Responses
{
    ...
    public class HtmlResponse : Response
    {
        ...
        public HtmlResponse(HttpStatusCode statusCode = HttpStatusCode.OK, Action<Stream> contents = null, IDictionary<string, string> headers = null, IEnumerable<IWebworkCookie> cookies = null)
        {
