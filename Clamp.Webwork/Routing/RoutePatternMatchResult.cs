namespace Clamp.Webwork.Routing
{
    ...
    public class RoutePatternMatchResult : IRoutePatternMatchResult
    {
        ...
        public RoutePatternMatchResult(bool isMatch, DynamicDictionary parameters, WebworkContext context)
        {
        ...
        /// <summary>
        /// Gets the <see cref="WebworkContext"/> that was active when the result was produced.
        /// </summary>
        /// <value>A <see cref="WebworkContext"/> instance.</value>
        public WebworkContext Context { get; private set; }
