namespace ShanDian.Webwork
{
    ...
    public static class ResponseExtensions
    {
        ...
        {
            return WithCookie(response, new WebworkCookie(name, value) { Expires = expires, Domain = domain, Path = path });
        }
        ...
        /// <returns></returns>
        public static Response WithCookie(this Response response, IWebworkCookie cookie)
        {
