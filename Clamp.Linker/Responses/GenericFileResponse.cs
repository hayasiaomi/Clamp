...
namespace Clamp.Linker.Responses
{
    ...
    public class GenericFileResponse : Response
    {
        ...
        public GenericFileResponse(string filePath, LinkerContext context)
        ...
        /// <param name="context">Current context</param>
        public GenericFileResponse(string filePath, string contentType, LinkerContext context = null)
        {
        ...
        private void InitializeGenericFileResponse(string filePath, string contentType, LinkerContext context)
        {
        ...
        private void SetResponseValues(string contentType, string fullPath, LinkerContext context)
        {
