using Clamp.MUI.Framework.Win32;
using System;
...
namespace Clamp.MUI.Framework.Shortcuts
{
    ...
    public class HotkeyBinder : IDisposable
    {
        ...
        public event Action<HotkeyAlreadyBoundException> OnHotkeyAlreadyRegistered;
        ...
        public HotkeyCallback Bind(Hotkey hotkeyCombo)
        {
            ...
            this.RegisterHotkey(hotkeyCombo);
        ...
        {
            bool successful = User32Dll.RegisterHotKey(hotkeyWindow.Handle, hotkeyCombo.GetHashCode(), (uint)hotkeyCombo.Modifier, (uint)hotkeyCombo.Key);
            ...
            if (!successful)
            {
                ...
                if ((uint)hr == 0x80070581)
                {
                    if (this.OnHotkeyAlreadyRegistered != null)
                        this.OnHotkeyAlreadyRegistered(new HotkeyAlreadyBoundException(Marshal.GetLastWin32Error()));
                }
            }
        }
