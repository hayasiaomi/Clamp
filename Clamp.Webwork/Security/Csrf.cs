namespace Clamp.Webwork.Security
{
    ...
    public static class Csrf
    {
        ...
        public static void Enable(IPipelines pipelines, CryptographyConfiguration cryptographyConfiguration = null)
        {
            ...
            var postHook = new PipelineItem<Action<WebworkContext>>(
                ...
                context =>
                {
                    ...
                    {
                        context.Response.Cookies.Add(new WebworkCookie(
                    ...
                    context.Response.Cookies.Add(new WebworkCookie(CsrfToken.DEFAULT_CSRF_KEY, tokenString, true));
                });
        ...
        public static void CreateNewCsrfToken(this IController module, CryptographyConfiguration cryptographyConfiguration = null)
        {
            var tokenString = GenerateTokenString(cryptographyConfiguration);
        ...
        public static void ValidateCsrfToken(this IController module, TimeSpan? validityPeriod = null)
        {
