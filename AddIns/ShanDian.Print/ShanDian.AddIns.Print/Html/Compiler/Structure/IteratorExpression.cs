...
{
    internal class IteratorExpression : HtmlTemplateExpression
    {
        private readonly Expression _sequence;
        private readonly Expression _template;
        private readonly Expression _ifEmpty;

        public IteratorExpression(Expression sequence, Expression template) : this(sequence, template, Expression.Empty())
        {
        }
        ...
        {
            get { return (ExpressionType)HtmlTemplateExpressionType.IteratorExpression; }
        }
    }
}
