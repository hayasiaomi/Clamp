namespace ShanDian.Webwork.ModelBinding
{
    using System;
    ...
    using ShanDian.Webwork.Validation;
    ...
    public static class ModuleExtensions
    {
        ...
        public static dynamic Bind(this IController module, params string[] blacklistedProperties)
        {
        ...
        /// <param name="blacklistedProperties">Property names to blacklist from binding</param>
        /// <returns>Model adapter - cast to a model type to bind it</returns>
        public static dynamic Bind(this IController module, BindingConfig configuration, params string[] blacklistedProperties)
        {
        ...
        public static TModel Bind<TModel>(this IController module)
        {
            return module.Bind();
        }
        ...
        /// <param name="blacklistedProperties">Property names to blacklist from binding</param>
        /// <returns>Bound model instance</returns>
        public static TModel Bind<TModel>(this IController module, params string[] blacklistedProperties)
        {
        ...
        /// <returns>Bound model instance</returns>
        public static TModel Bind<TModel>(this IController module, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        public static TModel BindAndValidate<TModel>(this IController module, params string[] blacklistedProperties)
        {
        ...
        /// <returns>Bound model instance</returns>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindAndValidate<TModel>(this IController module, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        /// <returns>Bound model instance</returns>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindAndValidate<TModel>(this IController module)
        {
        ...
        /// <param name="configuration">The <see cref="BindingConfig"/> that should be applied during binding.</param>
        /// <returns>Bound model instance</returns>
        public static TModel Bind<TModel>(this IController module, BindingConfig configuration)
        {
        ...
        /// <param name="blacklistedProperties">Property names to blacklist from binding</param>
        /// <returns>Bound model instance</returns>
        public static TModel Bind<TModel>(this IController module, BindingConfig configuration, params string[] blacklistedProperties)
        {
        ...
        /// <example>this.Bind&lt;Person&gt;(p =&gt; p.Name, p =&gt; p.Age)</example>
        /// <returns>Bound model instance</returns>
        public static TModel Bind<TModel>(this IController module, BindingConfig configuration, Expression<Func<TModel, object>> blacklistedProperty)
        {
        ...
        /// <example>this.Bind&lt;Person&gt;(p =&gt; p.Name, p =&gt; p.Age)</example>
        /// <returns>Bound model instance</returns>
        public static TModel Bind<TModel>(this IController module, BindingConfig configuration, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        /// <returns>Bound model instance</returns>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindAndValidate<TModel>(this IController module, BindingConfig configuration, params string[] blacklistedProperties)
        {
        ...
        /// <returns>Bound model instance</returns>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindAndValidate<TModel>(this IController module, BindingConfig configuration, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        /// <returns>Bound model instance</returns>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindAndValidate<TModel>(this IController module, BindingConfig configuration)
        {
        ...
        /// <param name="blacklistedProperties">Property names to blacklist from binding</param>
        public static TModel BindTo<TModel>(this IController module, TModel instance, params string[] blacklistedProperties)
        {
        ...
        /// <param name="blacklistedProperties">Expressions that tell which property should be ignored</param>
        /// <example>this.Bind&lt;Person&gt;(p =&gt; p.Name, p =&gt; p.Age)</example>
        public static TModel BindTo<TModel>(this IController module, TModel instance, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        /// <param name="module">Current module</param>
        /// <param name="instance">The class instance to bind properties to</param>
        public static TModel BindTo<TModel>(this IController module, TModel instance)
        {
        ...
        /// <param name="blacklistedProperties">Property names to blacklist from binding</param>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindToAndValidate<TModel>(this IController module, TModel instance, params string[] blacklistedProperties)
        {
        ...
        /// <example>this.Bind&lt;Person&gt;(p =&gt; p.Name, p =&gt; p.Age)</example>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindToAndValidate<TModel>(this IController module, TModel instance, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        /// <param name="instance">The class instance to bind properties to</param>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindToAndValidate<TModel>(this IController module, TModel instance)
        {
        ...
        /// <param name="configuration">The <see cref="BindingConfig"/> that should be applied during binding.</param>
        /// <param name="blacklistedProperties">Property names to blacklist from binding</param>
        public static TModel BindTo<TModel>(this IController module, TModel instance, BindingConfig configuration, params string[] blacklistedProperties)
        {
            dynamic adapter =
        ...
        /// <param name="blacklistedProperties">Expressions that tell which property should be ignored</param>
        /// <example>this.Bind&lt;Person&gt;(p =&gt; p.Name, p =&gt; p.Age)</example>
        public static TModel BindTo<TModel>(this IController module, TModel instance, BindingConfig configuration, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        /// <param name="instance">The class instance to bind properties to</param>
        /// <param name="configuration">The <see cref="BindingConfig"/> that should be applied during binding.</param>
        public static TModel BindTo<TModel>(this IController module, TModel instance, BindingConfig configuration)
        {
        ...
        /// <param name="blacklistedProperties">Property names to blacklist from binding</param>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindToAndValidate<TModel>(this IController module, TModel instance, BindingConfig configuration, params string[] blacklistedProperties)
        {
        ...
        public static TModel BindToAndValidate<TModel>(this IController module, TModel instance, BindingConfig configuration, params Expression<Func<TModel, object>>[] blacklistedProperties)
        {
        ...
        /// <param name="configuration">The <see cref="BindingConfig"/> that should be applied during binding.</param>
        /// <remarks><see cref="ModelValidationResult"/> is stored in NancyModule.ModelValidationResult and NancyContext.ModelValidationResult.</remarks>
        public static TModel BindToAndValidate<TModel>(this IController module, TModel instance, BindingConfig configuration)
        {
