namespace Clamp.Linker
{
    ...
    {
        private static readonly PipelineItem<Action<LinkerContext>> JsonpItem;

        static Jsonp()
        {
            JsonpItem = new PipelineItem<Action<LinkerContext>>("JSONP", PrepareJsonp);
        }
        ...
        private static void PrepareJsonp(LinkerContext context)
        {
