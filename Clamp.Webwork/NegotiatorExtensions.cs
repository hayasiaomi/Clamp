namespace Clamp.Webwork
{
    ...
    public static class NegotiatorExtensions
    {
        ...
        /// <param name="cookie">The <see cref="IWebworkCookie"/> instance that should be added.</param>
        /// <returns>The modified <see cref="Negotiator"/> instance.</returns>
        public static Negotiator WithCookie(this Negotiator negotiator, IWebworkCookie cookie)
        {
        ...
        /// </summary>
        /// <param name="negotiator">The <see cref="Negotiator"/> instance.</param>
        /// <param name="cookies">The <see cref="IWebworkCookie"/> instances that should be added.</param>
        /// <returns>The modified <see cref="Negotiator"/> instance.</returns>
        public static Negotiator WithCookies(this Negotiator negotiator, IEnumerable<IWebworkCookie> cookies)
        {
