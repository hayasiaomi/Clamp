namespace ShanDian.Webwork
{
    ...
    public static class StaticConfiguration
    {
        ...
        private static bool GetDebugMode()
        {
            try
            {
                ...
                var assembliesInDebug
                    = AppDomainAssemblyTypeScanner.TypesOf<IController>(ScanMode.ExcludeWebwork)
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ShanDian.Webwork.StaticConfiguration"/> allow file stream
