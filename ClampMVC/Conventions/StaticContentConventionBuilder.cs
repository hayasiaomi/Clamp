...
namespace ClampMVC.Conventions
{
    ...
    {
        private static readonly ConcurrentDictionary<ResponseFactoryCacheKey, Func<WebworkContext, Response>> ResponseFactoryCache;
        private static readonly Regex PathReplaceRegex = new Regex(@"[/\\]", RegexOptions.Compiled);

        static StaticContentConventionBuilder()
        {
            ResponseFactoryCache = new ConcurrentDictionary<ResponseFactoryCacheKey, Func<WebworkContext, Response>>();
        }
        ...
        public static Func<WebworkContext, string, Response> AddDirectory(string requestedPath, string contentPath = null, params string[] allowedExtensions)
        {
        ...
        public static Func<WebworkContext, string, Response> AddFile(string requestedFile, string contentFile)
        {
            return (ctx, root) =>
            {
        ...
        private static Func<ResponseFactoryCacheKey, Func<WebworkContext, Response>> BuildContentDelegate(WebworkContext context, string applicationRootPath, string requestedPath, string contentPath, string[] allowedExtensions)
        {
