namespace ShanDian.Webwork.Responses.Negotiation
{
    using System;
    ...
    public class NegotiationContext
    {
        ...
        {
            this.Cookies = new List<IWebworkCookie>();
        ...
        /// </summary>
        /// <value>An <see cref="IList{T}"/> of <see cref="IWebworkCookie"/> instances.</value>
        public IList<IWebworkCookie> Cookies { get; set; }
        ...
        internal void SetModule(IController module)
        {
            if (module == null)
            {
            ...
            this.ModuleLocation = module.ModuleLocation;
        }
    }
}