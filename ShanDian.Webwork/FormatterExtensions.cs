namespace ShanDian.Webwork
{
    ...
    public static class FormatterExtensions
    {
        ...
        public static Response AsRedirect(this IResponseFormatter formatter, string location, ShanDian.Webwork.Responses.RedirectResponse.RedirectType type = RedirectResponse.RedirectType.SeeOther)
        {
