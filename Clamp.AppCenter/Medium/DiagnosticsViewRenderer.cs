...
using ClampMVC.ViewEngines.SuperSimpleViewEngine;
...
namespace Clamp.AppCenter.Medium
{
    ...
    public class DiagnosticsViewRenderer
    {
        ...
        {
            var view = new EmbeddedFileResponse(typeof(DiagnosticsViewRenderer).Assembly, "ShanDian.Webwork.Diagnostics.Views", name);
        ...
        {
            return new ViewLocationResult("ShanDian/Webwork/Diagnostics/Views", name, "sshtml", () => new StreamReader(bodyStream));
        }
