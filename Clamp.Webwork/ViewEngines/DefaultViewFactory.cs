namespace Clamp.Webwork.ViewEngines
{
    using System;
    ...
    public class DefaultViewFactory : IViewFactory
    {
        ...
        public Response RenderView(string viewName, dynamic model, ViewLocationContext viewLocationContext)
        {
            ...
            var actualViewName = viewName ?? GetViewNameFromModel(model, viewLocationContext.Context);
        ...
        {
            var viewLocationResult = this.viewResolver.GetViewLocation(viewName, model, viewLocationContext);

            var resolvedViewEngine = GetViewEngine(viewLocationResult, viewLocationContext.Context);
        ...
        private IViewEngine GetViewEngine(ViewLocationResult viewLocationResult, WebworkContext context)
        {
        ...
        private static string GetViewNameFromModel(dynamic model, WebworkContext context)
        {
