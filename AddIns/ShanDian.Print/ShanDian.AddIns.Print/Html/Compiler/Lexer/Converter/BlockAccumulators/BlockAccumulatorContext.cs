...
namespace ShanDian.AddIns.Print.Html.Compiler
{
    ...
    {
        public static BlockAccumulatorContext Create(Expression item, HtmlTemplateConfiguration configuration)
        {
        ...
        private static bool IsBlockHelper(Expression item, HtmlTemplateConfiguration configuration)
        {
            item = UnwrapStatement(item);
