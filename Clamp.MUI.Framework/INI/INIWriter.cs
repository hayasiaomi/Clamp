...
namespace Clamp.MUI.Framework.INI
{
    internal static class INIWriter
    {
        ...
        internal static void WriteToStreamTextual(INIFile settingFile, Stream stream, Encoding encoding)
        {
        ...
        internal static void WriteToStreamBinary(INIFile cfg, Stream stream, BinaryWriter writer)
        {
        ...
        private static void WriteCommentsBinary(BinaryWriter writer, INIElement element)
        {
