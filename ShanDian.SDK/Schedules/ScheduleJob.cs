...
namespace ShanDian.SDK.Schedules
{
    ...
    internal class ScheduleJob
    {
        ...
        internal ICollection<ScheduleJob> AdditionalSchedules { get; set; }

        internal ScheduleJob Parent { get; set; }
        ...
        public ScheduleJob(Action action) : this(new[] { action }) { }

        /// <summary>
        /// Schedules a new job in the Scheduler.
        /// </summary>
        /// <param name="actions">Jobs to schedule</param>
        public ScheduleJob(IEnumerable<Action> actions)
        {
            Disabled = false;
            Jobs = actions.ToList();
            AdditionalSchedules = new List<ScheduleJob>();
        ...
        public ScheduleJob AndThen(Action job)
        {
            if (job == null)
        ...
        /// </summary>
        /// <param name="job">Job to run.</param>
        public ScheduleJob AndThen(IJob job)
        {
            if (job == null)
                throw new ArgumentNullException("job");
        ...
        /// </summary>
        /// <param name="job">Job to run.</param>
        public ScheduleJob AndThen(Func<IJob> job)
        {
            if (job == null)
                throw new ArgumentNullException("job");
        ...
        public ScheduleJob AndThen<T>() where T : IJob
        {
        ...
        public ScheduleJob WithName(string name)
        {
            Name = name;
            return this;
        }
        ...
        /// </summary>
        public ScheduleJob NonReentrant()
        {
