...
{
    class MainUpdateChecker : UpdateChecker
    {
        private UpgradeWebClient webClient;
        private string tempFile;


        public MainUpdateChecker(string updateProcessPath, string checkURL, string updateDownloadPath)
        {
        ...
        private UpdateInfo GetUpdateInfo(string url)
        {
            ...
            if (!string.IsNullOrWhiteSpace(url))
            {
                ...
                updateInfo = httpResponse.AsDeserializeBody<UpdateInfo>();
            }
        ...
        public override void DownloadUpdate()
        {
            if (this.UpdateInfo != null)
            {
                ...
                {
                    var uri = new Uri(this.UpdateInfo.DownloadUrl);
