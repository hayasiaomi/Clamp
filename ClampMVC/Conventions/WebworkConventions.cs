namespace Clamp.Linker.Conventions
{
    ...
    public class WebworkConventions
    {
        ...
        /// </summary>
        public IList<Func<LinkerContext, string, Response>> StaticContentsConventions { get; set; }
        ...
        /// </summary>
        public IList<Func<IEnumerable<Tuple<string, decimal>>, LinkerContext, IEnumerable<Tuple<string, decimal>>>> AcceptHeaderCoercionConventions { get; set; }

        /// <summary>
        /// Gets or sets the conventions for determining request culture
        /// </summary>
        public IList<Func<LinkerContext, CultureInfo>> CultureConventions { get; set; }
