namespace ShanDian.Webwork.Validation
{
    using System.Linq;

    /// <summary>
    /// Extensions to <see cref="IController"/> for validation.
    /// </summary>
    public static class ModuleExtensions
    {
        ...
        public static ModelValidationResult Validate<T>(this IController module, T instance)
        {
            var validator =
