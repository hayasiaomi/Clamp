namespace Clamp.Webwork
{
    ...
    public static class FormatterExtensions
    {
        ...
        public static Response AsRedirect(this IResponseFormatter formatter, string location, Clamp.Webwork.Responses.RedirectResponse.RedirectType type = RedirectResponse.RedirectType.SeeOther)
        {
