namespace Clamp.Linker.Conventions
{
    ...
    public static class StaticContentsConventionsExtensions
    {
        ...
        public static void AddDirectory(this IList<Func<LinkerContext, string, Response>> conventions, string requestedPath, string contentPath = null, params string[] allowedExtensions)
        {
        ...
        public static void AddFile(this IList<Func<LinkerContext, string, Response>> conventions, string requestedFile, string contentFile)
        {
