namespace Clamp.Linker.Routing
{
    ...
    public class Route
    {
        ...
        /// <param name="action">The action that should take place when the route is invoked.</param>
        public Route(string name, string method, string path, Func<LinkerContext, bool> condition, Func<dynamic, CancellationToken, Task<dynamic>> action)
        ...
        /// <param name="action">The action that should take place when the route is invoked.</param>
        public Route(string method, string path, Func<LinkerContext, bool> condition, Func<dynamic, CancellationToken, Task<dynamic>> action)
        ...
        /// <param name="syncFunc">The action that should take place when the route is invoked.</param>
        /// <returns>A Route instance</returns>
        public static Route FromSync(string method, string path, Func<LinkerContext, bool> condition, Func<dynamic, dynamic> syncFunc)
        {
        ...
        /// <param name="syncFunc">The action that should take place when the route is invoked.</param>
        /// <returns>A Route instance</returns>
        public static Route FromSync(string name, string method, string path, Func<LinkerContext, bool> condition, Func<dynamic, dynamic> syncFunc)
        {
