namespace Clamp.Linker
{
    ...
    public class Response: IDisposable
    {
        ...
        public Response()
        {
            ...
            this.Cookies = new List<IWebworkCookie>(2);
        }
        ...
        /// <summary>
        /// Gets the <see cref="IWebworkCookie"/> instances that are associated with the response.
        /// </summary>
        /// <value>A <see cref="IList{T}"/> instance, containing <see cref="IWebworkCookie"/> instances.</value>
        public IList<IWebworkCookie> Cookies { get; private set; }
        ...
        /// <summary>
        /// Adds a <see cref="IWebworkCookie"/> to the response.
        /// </summary>
        ...
        {
            return AddCookie(new WebworkCookie(name, value){ Expires = expires, Domain = domain, Path = path });
        }

        /// <summary>
        /// Adds a <see cref="IWebworkCookie"/> to the response.
        /// </summary>
        /// <param name="cookie">A <see cref="IWebworkCookie"/> instance.</param>
        /// <returns></returns>
        [Obsolete("This method has been replaced with Response.WithCookie and will be removed in a subsequent release.")]
        public Response AddCookie(IWebworkCookie cookie)
        {
            Cookies.Add(cookie);
            return this;
        }
