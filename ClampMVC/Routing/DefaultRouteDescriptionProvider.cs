namespace Clamp.Linker.Routing
{
    ...
    public class DefaultRouteDescriptionProvider : IRouteDescriptionProvider
    {
        ...
        public string GetDescription(IController module, string path)
        {
            ...
            var resourceName = assembly.GetManifestResourceNames().FirstOrDefault(x => x.Equals(moduleName, StringComparison.OrdinalIgnoreCase));
