namespace ShanDian.Webwork
{
    ...
    using ShanDian.Webwork.Session;
    ...
    /// </summary>
    public abstract class Controller : IController, IHideObjectMembers
    {
        ...
        /// </summary>
        protected Controller() : this(String.Empty)
        {
        ...
        protected Controller(string modulePath)
        {
            ...
            this.ModuleLocation = this.GetType().Assembly.Location;
        }
        ...
        public string ModuleLocation { set; get; }
        ...
        public class RouteBuilder : IHideObjectMembers
        {
            ...
            private readonly Controller parentModule;
            ...
            /// <param name="parentModule">The <see cref="IController"/> that the route is being configured for.</param>
            public RouteBuilder(string method, Controller parentModule)
            {
                this.method = method;
            ...
            /// </summary>
            /// <value>A delegate that is used to invoke the route.</value>
            public Func<dynamic, dynamic> this[string path, Func<WebworkContext, bool> condition]
            {
            ...
            /// </summary>
            public Func<dynamic, CancellationToken, Task<dynamic>> this[string path, Func<WebworkContext, bool> condition, bool runAsync]
            {
                set { this.AddRoute(string.Empty, path, condition, value); }
            }
            ...
            /// </summary>
            /// <value>A delegate that is used to invoke the route.</value>
            public Func<dynamic, dynamic> this[string name, string path, Func<WebworkContext, bool> condition]
            {
            ...
            /// </summary>
            public Func<dynamic, CancellationToken, Task<dynamic>> this[string name, string path, Func<WebworkContext, bool> condition, bool runAsync]
            {
                set { this.AddRoute(name, path, condition, value); }
            }

            protected void AddRoute(string name, string path, Func<WebworkContext, bool> condition, Func<dynamic, dynamic> value)
            {
            ...
            protected void AddRoute(string name, string path, Func<WebworkContext, bool> condition, Func<dynamic, CancellationToken, Task<dynamic>> value)
            {
                var fullPath = GetFullPath(path);
