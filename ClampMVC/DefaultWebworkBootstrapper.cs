namespace ClampMVC
{
    ...
    /// </summary>
    public class DefaultWebworkBootstrapper : WebworkBootstrapperWithRequestContainerBase<TinyIoCContainer>
    {
        /// <summary>
        ...
        protected override sealed IWebworkEngine GetEngineInternal()
        {
            return this.ApplicationContainer.Resolve<IWebworkEngine>();
        }
        ...
        protected override TinyIoCContainer CreateRequestContainer(WebworkContext context)
        {
        ...
        {
            var assembly = typeof(WebworkEngine).Assembly;
