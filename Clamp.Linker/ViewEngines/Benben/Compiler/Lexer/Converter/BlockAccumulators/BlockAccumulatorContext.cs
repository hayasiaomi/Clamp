...
namespace Clamp.Linker.ViewEngines.Benben.Compiler
{
    ...
    {
        public static BlockAccumulatorContext Create(Expression item, BenbenConfiguration configuration)
        {
        ...
        private static bool IsBlockHelper(Expression item, BenbenConfiguration configuration)
        {
            item = UnwrapStatement(item);
