namespace Clamp.SDK.Schedules
{
    ...
    /// </summary>
    internal sealed class MonthOnDayOfMonthUnit : IDayRestrictableUnit
    {
        private readonly int _duration;

        private readonly int _dayOfMonth;

        internal MonthOnDayOfMonthUnit(ScheduleJob schedule, int duration, int dayOfMonth)
        {
            _duration = duration;
        ...
        ScheduleJob IDayRestrictableUnit.Schedule { get { return this.Schedule; } }
