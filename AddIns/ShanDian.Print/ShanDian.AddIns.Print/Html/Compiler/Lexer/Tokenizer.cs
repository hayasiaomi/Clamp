...
namespace ShanDian.AddIns.Print.Html.Compiler.Lexer
{
    internal class Tokenizer
    {
        ...
        public Tokenizer(HtmlTemplateConfiguration configuration)
        {
        ...
        public IEnumerable<Token> Tokenize(TextReader source)
        {
            ...
            {
                throw new HtmlTemplateParserException("An unhandled exception occurred while trying to compile the template", ex);
            }
        }
                ...
                if (inExpression)
                {
                    ...
                    else
                    {
                        if (token == null)
                        {
                            ...
                            throw new HtmlTemplateParserException("Reached unparseable token in expression: " + source.ReadLine());
                        }
                        node = source.Read();
                    }
                }
