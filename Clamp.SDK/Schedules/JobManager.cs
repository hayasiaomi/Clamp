namespace Clamp.SDK.Schedules
{
    ...
    internal static class JobManager
    {
        ...
        private static readonly ISet<Tuple<ScheduleJob, Task>> _running = new HashSet<Tuple<ScheduleJob, Task>>();
        ...
        public static void Initialize(params Scheduler[] registries)
        {
        ...
        /// </summary>
        /// <param name="registries">Registries of jobs to run</param>
        public static void InitializeWithoutStarting(params Scheduler[] registries)
        {
            if (registries == null)
        ...
        public static ScheduleJob GetSchedule(string name)
        {
        ...
        /// </summary>
        public static IEnumerable<ScheduleJob> RunningSchedules
        {
            get
            {
                lock (_running)
        ...
        /// </summary>
        public static IEnumerable<ScheduleJob> AllSchedules
        {
            get
            {
        ...
        #region Exposing adding & removing jobs (without the Scheduler)
        ...
        public static void AddJob(Action job, Action<ScheduleJob> schedule)
        {
            if (job == null)
            ...
            AddJob(schedule, new ScheduleJob(job));
        }
        ...
        /// <param name="job">Job to run.</param>
        /// <param name="schedule">Job schedule to add.</param>
        public static void AddJob(IJob job, Action<ScheduleJob> schedule)
        {
            if (job == null)
                throw new ArgumentNullException("job");
            ...
            AddJob(schedule, new ScheduleJob(JobManager.GetJobAction(job)));
        }
        ...
        public static void AddJob<T>(Action<ScheduleJob> schedule) where T : IJob
        {
            if (schedule == null)
                throw new ArgumentNullException("schedule");

            AddJob(schedule, new ScheduleJob(JobManager.GetJobAction<T>()) { Name = typeof(T).Name });
        }

        private static void AddJob(Action<ScheduleJob> jobSchedule, ScheduleJob schedule)
        {
            jobSchedule(schedule);
            CalculateNextRun(new ScheduleJob[] { schedule }).ToList().ForEach(RunJob);
            ScheduleJobs();
        }
        ...
        private static IEnumerable<ScheduleJob> CalculateNextRun(IEnumerable<ScheduleJob> schedules)
        {
        ...
        internal static void RunJob(ScheduleJob schedule)
        {
            ...
            Tuple<ScheduleJob, Task> tuple = null;
            ...
            tuple = new Tuple<ScheduleJob, Task>(schedule, task);
