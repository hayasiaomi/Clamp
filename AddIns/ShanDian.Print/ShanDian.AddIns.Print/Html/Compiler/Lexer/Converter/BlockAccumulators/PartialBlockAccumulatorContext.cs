...
namespace ShanDian.AddIns.Print.Html.Compiler
{
    internal class PartialBlockAccumulatorContext : BlockAccumulatorContext
    {
        ...
        public PartialBlockAccumulatorContext(Expression startingNode) : base(startingNode)
        {
        ...
        {
            return HtmlTemplateExpression.Partial(
        ...
        private PartialExpression ConvertToPartialExpression(Expression expression)
        {
            if (expression is PathExpression)
            {
                ...
                return HtmlTemplateExpression.Partial(Expression.Constant(_blockName));
            }
