...
namespace Clamp.Linker.ViewEngines.Benben
{
    ...
    public partial class Benben
    {
        private class BenbenEnvironment : IBenbenEnvironment
        {
            private readonly BenbenConfiguration _configuration;
            private readonly HandlebarsCompiler _compiler;

            public BenbenEnvironment(BenbenConfiguration configuration)
            {
            ...
            public BenbenConfiguration Configuration
            {
                get
                {
            ...
            public void RegisterHelper(string helperName, BenbenHelper helperFunction)
            {
                lock (_configuration)
                {
            ...
            public void RegisterHelper(string helperName, BenbenBlockHelper helperFunction)
            {
                lock (_configuration)
                {
