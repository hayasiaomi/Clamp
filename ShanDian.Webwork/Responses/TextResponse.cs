namespace ShanDian.Webwork.Responses
{
    ...
    public class TextResponse : Response
    {
        ...
        public TextResponse(HttpStatusCode statusCode = HttpStatusCode.OK, string contents = null, Encoding encoding = null, IDictionary<string, string> headers = null, IEnumerable<IWebworkCookie> cookies = null)
        {
            if (encoding == null)
            {
                encoding = Encoding.UTF8;
