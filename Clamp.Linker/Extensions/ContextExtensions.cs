namespace Clamp.Linker.Extensions
{
    ...
    /// <summary>
    /// Containing extensions for the <see cref="LinkerContext"/> object
    /// </summary>
    public static class ContextExtensions
    {
        ...
        public static bool IsAjaxRequest(this LinkerContext context)
        {
        ...
        public static string ToFullPath(this LinkerContext context, string path)
        {
        ...
        public static RedirectResponse GetRedirect(this LinkerContext context, string path)
        {
        ...
        public static string GetExceptionDetails(this LinkerContext context)
        {
            object errorObject;
            context.Items.TryGetValue(LinkerEngine.ERROR_KEY, out errorObject);
        ...
        public static Exception GetException(this LinkerContext context)
        {
        ...
        /// <param name="context">The context.</param>
        /// <returns>The thrown exception or <c>null</c> if not exception has been thrown.</returns>
        public static T GetException<T>(this LinkerContext context) where T : Exception
        {
            T exception;
        ...
        public static bool TryGetException(this LinkerContext context, out Exception exception)
        {
        ...
        public static bool TryGetException<T>(this LinkerContext context, out T exception) where T : Exception
        {
            object exceptionObject;
            if (context.Items.TryGetValue(LinkerEngine.ERROR_EXCEPTION, out exceptionObject) && exceptionObject is T)
            {
        ...
        public static void WriteTraceLog(this LinkerContext context, Action<StringBuilder> logDelegate)
        {
        ...
        public static bool IsLocalUrl(this LinkerContext context, string url)
        {
