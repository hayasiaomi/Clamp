namespace ShanDian.Webwork.Bootstrapper
{
    ...
    public abstract class WebworkBootstrapperWithRequestContainerBase<TContainer> : WebworkBootstrapperBase<TContainer>
        where TContainer : class
    {
        protected WebworkBootstrapperWithRequestContainerBase()
        {
        ...
        /// <summary>
        /// Get all <see cref="IController"/> implementation instances
        /// </summary>
        /// <param name="context">The current context</param>
        /// <returns>An <see cref="IEnumerable{T}"/> instance containing <see cref="IController"/> instances.</returns>
        public override sealed IEnumerable<IController> GetAllModules(WebworkContext context)
        {
        ...
        public override sealed IController GetModule(Type moduleType, WebworkContext context)
        {
            var requestContainer = this.GetConfiguredRequestContainer(context);
        ...
        protected override sealed IPipelines InitializeRequestPipelines(WebworkContext context)
        {
            var requestContainer = this.GetConfiguredRequestContainer(context);
        ...
        protected TContainer GetConfiguredRequestContainer(WebworkContext context)
        {
        ...
        protected virtual void ConfigureRequestContainer(TContainer container, WebworkContext context)
        {
        }
        ...
        /// <param name="context">Current context</param>
        /// <returns>Request container instance</returns>
        protected abstract TContainer CreateRequestContainer(WebworkContext context);
        ...
        protected abstract IEnumerable<IController> GetAllModules(TContainer container);
        ...
        protected abstract IController GetModule(TContainer container, Type moduleType);
    }
}