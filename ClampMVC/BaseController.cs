namespace ClampMVC
{
    ...
    /// </summary>
    public abstract class BaseController : IController, IHideObjectMembers
    {
        ...
        /// </summary>
        protected BaseController() : this(String.Empty)
        {
        ...
        protected BaseController(string modulePath)
        {
        ...
        public class RouteBuilder : IHideObjectMembers
        {
            ...
            private readonly BaseController parentModule;
            ...
            public RouteBuilder(string method, BaseController parentModule)
            {
                this.method = method;
