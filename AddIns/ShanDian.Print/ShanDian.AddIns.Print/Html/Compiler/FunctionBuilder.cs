...
namespace ShanDian.AddIns.Print.Html.Compiler
{
    internal class FunctionBuilder
    {
        ...
        public FunctionBuilder(HtmlTemplateConfiguration configuration)
        {
        ...
        public Expression Compile(IEnumerable<Expression> expressions, Expression parentContext, string templatePath = null)
        {
            ...
            {
                throw new HtmlTemplateCompilerException("An unhandled exception occurred while trying to compile the template", ex);
            }
        }
